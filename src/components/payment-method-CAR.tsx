...
import { CreditCard, Plane, Calendar, Clock, Users, DollarSign, Car } from "lucide-react"
...
interface PaymentMethodPropsCar {
      ...
      <CardContent className="space-y-6 flex gap-5">
        ...
        <div className="bg-gray-50 p-4 rounded-lg space-y-3 w-lg">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div className="font-medium">{carDetails.id}</div>

            <div className="flex items-center gap-2">
              <span className="text-gray-600">City:</span>
            </div>
            <div className="font-medium">{carDetails.locacion}</div>

            <div className="flex items-center gap-2">
              <span className="text-gray-600">Marca:</span>
            </div>
            <div className="font-medium">{carDetails.marca}</div>

            <div className="flex items-center gap-2">
            
              <span className="text-gray-600">Modelo:</span>
            </div>
            <div className="font-medium">{carDetails.modelo}</div>

            <div className="flex items-center gap-2">
              <span className="text-gray-600">Placa:</span>
            </div>
            <div className="font-medium">{carDetails.placa}</div>
